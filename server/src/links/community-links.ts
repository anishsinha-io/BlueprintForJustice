...
const communityLinks: LinkData = {
  "Organizations on the National Level": [
    ...
    },
    {
      ...
      description:
        "The Black Mamas Matter Alliance advocates for the advancement of Black maternal health, rights and justice. ",
    },
    {
      text: "National Police Accountability Project",
      href: "https://www.nlg-npap.org/",
      description:
        "The National Police Accountability Project (NPAP) was founded by the National Lawyers Guild and works to protect the human and civil rights of individuals in their encounters with law enforcement and detention facility personnel. ",
    },
    {
      text: "The Center For Justice and Accountability",
      href: "https://cja.org/",
      description:
        "The Center for Justice and Accountability (CJA) is an international organization that fights severe human rights abuse through litigation, policy change, and transitional justice strategies. ",
    },
    {
  ...
  "Organizations on a Local Level": [
    {
      ...
      description:
        "The Black Community Building Collective is a coalition of Black-led organizations brought together by United Way of King County to create connections, form strategies to support the Black community, and fund these strategies through participatory grantmaking.",
    },
    {
