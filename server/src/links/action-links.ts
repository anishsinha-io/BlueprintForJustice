...
const actionLinks: LinkData = {
  "Where To Start Building a Community": [
    ...
    },
    {
      ...
      description:
        "Campaign Zero is a non-profit organization that encourages policy makers at every level of government to focus on creating the most effective solutions for reducing police brutality.",
    },
    {
  ...
  "Running for Office": [
    ...
    },
    {
      ...
      description:
        "Running for Something recruits individuals nationwide to run for state or local office. They provide resources for new progressive leaders to help them run grassroots campaigns.",
    },
    {
      text: "National Democratic Training Committee",
      href: "https://traindemocrats.org/",
      description:
        "The National Democratic Training Committee trains democrats on running campaigns. They provide Democratic candidates, campaign staffers, and local leaders the tools, expert training, and resources needed to win.",
    },
    {
      text: "She Should Run",
  ...
  "Economic Disparity": [
    {
      ...
      description:
        "The Ordinary People Society has has played a critical role in organizing and mobilizing communities across the deep South. T.O.P.S. recognizes the disparities in homelessness, arrest, and bail in impoverished areas and provides advocacy and support to those impacted by the criminal justice system. ",
    },
  ],
  "Prisoners' Rights": [
    {
  ...
  "Legislative Change": [
    ...
    },
    {
      ...
      description:
        "Bolder Advocacy is a group of lawyers, coaches, and nonprofit experts that aim to make advocacy easy and accessible for you. We help nonprofits take part in activities that influence public policy",
    },
    {
    ...
    },
    {
      ...
      description:
        "Rooted in the great human rights struggles for equality and justice, Advancement Project exists to fulfill America's promise of a caring, inclusive and just democracy.",
    },
  ],
};
